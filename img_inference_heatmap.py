...
if __name__ == "__main__":
    ...
    arg_parser.add_argument('--tasks_path', default="./dataset/debug/train/demo_bag", type=str)
    ...
    for task_path in task_paths:
        ...
        for frame_idx in tqdm(range(frame_num), desc = os.path.basename(task_path)):
            ...
            bev_path = os.path.join(task_path, 'bev', file_prefix + '.png')
            ...
            out_traj = parking_model.predict(img_path_dict, bev_path, target_point, is_raw=True)
